...
import chainOfResponsability.problema.VendaCarroService;

import java.math.BigDecimal;

public class TestCarroComChainOfResponsability {
    ...
    public static void main(String[] args) {
        ...
        carro1.setPreco(BigDecimal.valueOf(90000.00));
        ...
        carro2.setPreco(BigDecimal.valueOf(40000.00));
        ...
        carro3.setPreco(BigDecimal.valueOf(200000.00));
